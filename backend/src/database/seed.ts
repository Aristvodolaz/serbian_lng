...
const UNITS: UnitSeed[] = [
  ...
  },
  {
    ...
    words: [
      { cyrillic: 'име', latin: 'ime', translation: 'имя', exampleCyrillic: 'Моје име је Марта.', exampleTranslation: 'Моё имя Марта.' },
      { cyrillic: 'зовати се', latin: 'zovati se', translation: 'зоваться', exampleCyrillic: 'Зовем се Ана.', exampleTranslation: 'Меня зовут Ана.' },
      { cyrillic: 'мој', latin: 'moj', translation: 'мой', exampleCyrillic: 'Ово је мој стан.', exampleTranslation: 'Это моя квартира.' },
      { cyrillic: 'твој', latin: 'tvoj', translation: 'твой', exampleCyrillic: 'Где је твоја књига?', exampleTranslation: 'Где твоя книга?' },
      { cyrillic: 'ја', latin: 'ja', translation: 'я', exampleCyrillic: 'Ја сам из Русије.', exampleTranslation: 'Я из России.' },
      { cyrillic: 'ти', latin: 'ti', translation: 'ты', exampleCyrillic: 'Ти си мој пријатељ.', exampleTranslation: 'Ты мой друг.' },
      { cyrillic: 'он', latin: 'on', translation: 'он', exampleCyrillic: 'Он је висок.', exampleTranslation: 'Он высокий.' },
      { cyrillic: 'она', latin: 'ona', translation: 'она', exampleCyrillic: 'Она је млада.', exampleTranslation: 'Она молодая.' },
      { cyrillic: 'ми', latin: 'mi', translation: 'мы', exampleCyrillic: 'Ми живимо у Београду.', exampleTranslation: 'Мы живём в Белграде.' },
      { cyrillic: 'српски', latin: 'srpski', translation: 'сербский (язык)', exampleCyrillic: 'Српски је леп језик.', exampleTranslation: 'Сербский — красивый язык.' },
      { cyrillic: 'језик', latin: 'jezik', translation: 'язык', exampleCyrillic: 'Учиш ли српски језик?', exampleTranslation: 'Ты учишь сербский язык?' },
      { cyrillic: 'говорити', latin: 'govoriti', translation: 'говорить', exampleCyrillic: 'Она добро говори српски.', exampleTranslation: 'Она хорошо говорит по-сербски.' },
      { cyrillic: 'град', latin: 'grad', translation: 'город', exampleCyrillic: 'Београд је велики град.', exampleTranslation: 'Белград — большой город.' },
      { cyrillic: 'земља', latin: 'zemlja', translation: 'страна; земля', exampleCyrillic: 'Србија је мала земља.', exampleTranslation: 'Сербия — маленькая страна.' },
      { cyrillic: 'главни', latin: 'glavni', translation: 'главный', exampleCyrillic: 'Главни град је Београд.', exampleTranslation: 'Столица — Белград.' },
      { cyrillic: 'пријатељ', latin: 'prijatelj', translation: 'друг', exampleCyrillic: 'Мој пријатељ живи у Новом Саду.', exampleTranslation: 'Мой друг живёт в Нови-Саде.' },
      { cyrillic: 'хвала', latin: 'hvala', translation: 'спасибо', exampleCyrillic: 'Хвала на помоћи.', exampleTranslation: 'Спасибо за помощь.' },
      { cyrillic: 'живети', latin: 'živeti', translation: 'жить', exampleCyrillic: 'Ја живим у Београду.', exampleTranslation: 'Я живу в Белграде.' },
      { cyrillic: 'стан', latin: 'stan', translation: 'квартира', exampleCyrillic: 'Наш стан је мали.', exampleTranslation: 'Наша квартира маленькая.' },
      { cyrillic: 'улица', latin: 'ulica', translation: 'улица', exampleCyrillic: 'Улица је дуга.', exampleTranslation: 'Улица длинная.' },
      { cyrillic: 'зграда', latin: 'zgrada', translation: 'здание', exampleCyrillic: 'Зграда има пет спратова.', exampleTranslation: 'В здании пять этажей.' },
      { cyrillic: 'радити', latin: 'raditi', translation: 'работать', exampleCyrillic: 'Ја радим од јутра до вечери.', exampleTranslation: 'Я работаю с утра до вечера.' },
      { cyrillic: 'посао', latin: 'posao', translation: 'работа', exampleCyrillic: 'Имам добар посао.', exampleTranslation: 'У меня хорошая работа.' },
      { cyrillic: 'школа', latin: 'škola', translation: 'школа', exampleCyrillic: 'Школа је близу дома.', exampleTranslation: 'Школа рядом с домом.' },
      { cyrillic: 'ученик', latin: 'učenik', translation: 'ученик (школьник)', exampleCyrillic: 'Он је ученик осмог разреда.', exampleTranslation: 'Он ученик восьмого класса.' },
      { cyrillic: 'студент', latin: 'student', translation: 'студент', exampleCyrillic: 'Она је студентка права.', exampleTranslation: 'Она студентка юридического факультета.' },
      { cyrillic: 'наставник', latin: 'nastavnik', translation: 'учитель; преподаватель', exampleCyrillic: 'Наш наставник је млад.', exampleTranslation: 'Наш преподаватель молодой.' },
      { cyrillic: 'лекар', latin: 'lekar', translation: 'врач', exampleCyrillic: 'Лектор је у болници.', exampleTranslation: 'Врач в больнице.' },
      { cyrillic: 'болница', latin: 'bolnica', translation: 'больница', exampleCyrillic: 'Болница је далеко.', exampleTranslation: 'Больница далеко.' },
      { cyrillic: 'инжењер', latin: 'inženjer', translation: 'инженер', exampleCyrillic: 'Мој отац је инжењер.', exampleTranslation: 'Мой отец инженер.' },
      { cyrillic: 'сусед', latin: 'susjed', translation: 'сосед', exampleCyrillic: 'Наш сусед је добар човек.', exampleTranslation: 'Наш сосед — хороший человек.' },
      { cyrillic: 'дом', latin: 'dom', translation: 'дом; домой', exampleCyrillic: 'Наш дом је нов.', exampleTranslation: 'Наш дом новый.' },
      { cyrillic: 'широк', latin: 'širok', translation: 'широкий', exampleCyrillic: 'Река је широка.', exampleTranslation: 'Река широкая.' },
      { cyrillic: 'дуг', latin: 'dug', translation: 'долг', exampleCyrillic: 'Он има велики дуг.', exampleTranslation: 'У него большой долг.' },
      { cyrillic: 'млад', latin: 'mlad', translation: 'молодой (м.р.)', exampleCyrillic: 'Млади човек је висок.', exampleTranslation: 'Молодой человек высокий.' },
      { cyrillic: 'стар', latin: 'star', translation: 'старый (м.р.)', exampleCyrillic: 'Стар човек спава.', exampleTranslation: 'Старик спит.' },
      { cyrillic: 'висок', latin: 'visok', translation: 'высокий', exampleCyrillic: 'Она је висока.', exampleTranslation: 'Она высокая.' },
      { cyrillic: 'низак', latin: 'nizak', translation: 'низкий (рост)', exampleCyrillic: 'Он је низак.', exampleTranslation: 'Он невысокий.' },
      { cyrillic: 'добар', latin: 'dobar', translation: 'хороший (м.р.)', exampleCyrillic: 'Ово је добар дан.', exampleTranslation: 'Сегодня хороший день.' },
      { cyrillic: 'лош', latin: 'loš', translation: 'плохой (м.р.)', exampleCyrillic: 'Ово је лош дан.', exampleTranslation: 'Сегодня плохой день.' },
      { cyrillic: 'нов', latin: 'nov', translation: 'новый (м.р.)', exampleCyrillic: 'Нов ауто је скуп.', exampleTranslation: 'Новая машина дорогая.' },
      { cyrillic: 'велики', latin: 'veliki', translation: 'большой', exampleCyrillic: 'Велики град има много људи.', exampleTranslation: 'В большом городе много людей.' },
      { cyrillic: 'мали', latin: 'mali', translation: 'маленький', exampleCyrillic: 'Мали стан је јефтин.', exampleTranslation: 'Маленькая квартира дешёвая.' },
      { cyrillic: 'леп', latin: 'lep', translation: 'красивый; хороший', exampleCyrillic: 'Леп дан за шетњу.', exampleTranslation: 'Красивый день для прогулки.' },
      { cyrillic: 'човек', latin: 'čovek', translation: 'человек', exampleCyrillic: 'Он је добар човек.', exampleTranslation: 'Он хороший человек.' },
      { cyrillic: 'дан', latin: 'dan', translation: 'день', exampleCyrillic: 'Овај дан је слободан.', exampleTranslation: 'Сегодня выходной.' },
      { cyrillic: 'боја', latin: 'boja', translation: 'цвет', exampleCyrillic: 'Плава је моја омилјена боја.', exampleTranslation: 'Синий — мой любимый цвет.' },
      { cyrillic: 'црвен', latin: 'crven', translation: 'красный', exampleCyrillic: 'Црвена боја ми се свиђа.', exampleTranslation: 'Мне нравится красный цвет.' },
      { cyrillic: 'плав', latin: 'plav', translation: 'синий', exampleCyrillic: 'Плаво небо је лепо.', exampleTranslation: 'Синее небо — красивое.' },
      { cyrillic: 'зелен', latin: 'zelen', translation: 'зелёный', exampleCyrillic: 'Зелено воће је кисело.', exampleTranslation: 'Зелёные фрукты кислые.' },
      { cyrillic: 'тешко', latin: 'teško', translation: 'трудно', exampleCyrillic: 'Ово је тешко питање.', exampleTranslation: 'Это трудный вопрос.' },
    ],
  },
  {
  ...
  },
  {
    ...
    words: [
      { cyrillic: 'понедељак', latin: 'ponedeljak', translation: 'понедельник', exampleCyrillic: 'Данас је понедељак.', exampleTranslation: 'Сегодня понедельник.' },
      { cyrillic: 'уторак', latin: 'utorak', translation: 'вторник', exampleCyrillic: 'Сутра је уторак.', exampleTranslation: 'Завтра вторник.' },
      { cyrillic: 'среда', latin: 'sreda', translation: 'среда', exampleCyrillic: 'Среда је мој омиљени дан.', exampleTranslation: 'Среда — мой любимый день.' },
      { cyrillic: 'четвртак', latin: 'četvrtak', translation: 'четверг', exampleCyrillic: 'Четвртак је дан за куповину.', exampleTranslation: 'Четверг — день для покупок.' },
      { cyrillic: 'петак', latin: 'petak', translation: 'пятница', exampleCyrillic: 'Петак је крај недели.', exampleTranslation: 'Пятница — конец недели.' },
      { cyrillic: 'субота', latin: 'subota', translation: 'суббота', exampleCyrillic: 'Субота је слободан дан.', exampleTranslation: 'Суббота — выходной.' },
      { cyrillic: 'недеља', latin: 'nedelja', translation: 'воскресенье; неделя', exampleCyrillic: 'Недеља је слободан дан.', exampleTranslation: 'Воскресенье — выходной.' },
      { cyrillic: 'јутро', latin: 'jutro', translation: 'утро', exampleCyrillic: 'Јутро је хладно.', exampleTranslation: 'Утро холодное.' },
      { cyrillic: 'подне', latin: 'podne', translation: 'полдень', exampleCyrillic: 'Сад је подне.', exampleTranslation: 'Сейчас полдень.' },
      { cyrillic: 'попладне', latin: 'popodne', translation: 'время дня после полудня', exampleCyrillic: 'У попладне идем у парк.', exampleTranslation: 'Днём я иду в парк.' },
      { cyrillic: 'сат', latin: 'sat', translation: 'час; часы', exampleCyrillic: 'Сат је на зиду.', exampleTranslation: 'Часы на стене.' },
      { cyrillic: 'минута', latin: 'minuta', translation: 'минута', exampleCyrillic: 'Чекajте пет минута.', exampleTranslation: 'Подождите пять минут.' },
      { cyrillic: 'данас', latin: 'danas', translation: 'сегодня', exampleCyrillic: 'Данас је леп дан.', exampleTranslation: 'Сегодня красивый день.' },
      { cyrillic: 'сутра', latin: 'sutra', translation: 'завтра', exampleCyrillic: 'Сутра идем на посао.', exampleTranslation: 'Завтра я иду на работу.' },
      { cyrillic: 'јуче', latin: 'juče', translation: 'вчера', exampleCyrillic: 'Јуче је био петак.', exampleTranslation: 'Вчера была пятница.' },
      { cyrillic: 'месец', latin: 'mesec', translation: 'месяц', exampleCyrillic: 'Овај месец је март.', exampleTranslation: 'Этот месяц — март.' },
      { cyrillic: 'годинa', latin: 'godina', translation: 'год; год (возраст)', exampleCyrillic: 'Она има двадесет година.', exampleTranslation: 'Ей двадцать лет.' },
      { cyrillic: 'увек', latin: 'uvek', translation: 'всегда', exampleCyrillic: 'Ја увек пијem кафу.', exampleTranslation: 'Я всегда пью кофе.' },
      { cyrillic: 'понекад', latin: 'ponekad', translation: 'иногда', exampleCyrillic: 'Понекад читам књигу.', exampleTranslation: 'Иногда я читаю книгу.' },
      { cyrillic: 'нула', latin: 'nula', translation: 'ноль', exampleCyrillic: 'Вани је нула степени.', exampleTranslation: 'Сейчас ноль градусов.' },
      { cyrillic: 'једan', latin: 'jedan', translation: 'один', exampleCyrillic: 'Једan сат је довољно.', exampleTranslation: 'Одного часа достаточно.' },
      { cyrillic: 'два', latin: 'dva', translation: 'два', exampleCyrillic: 'Два сата су дуги.', exampleTranslation: 'Два часа — это долго.' },
      { cyrillic: 'три', latin: 'tri', translation: 'три', exampleCyrillic: 'Имам три дана слободно.', exampleTranslation: 'У меня три дня выходных.' },
      { cyrillic: 'четири', latin: 'cetiri', translation: 'четыре', exampleCyrillic: 'Четири дана до викенда.', exampleTranslation: 'До выходных четыре дня.' },
      { cyrillic: 'пет', latin: 'pet', translation: 'пять', exampleCyrillic: 'Пет минута, молим.', exampleTranslation: 'Пять минут, пожалуйста.' },
      { cyrillic: 'шест', latin: 'šest', translation: 'шесть', exampleCyrillic: 'Шест сати ујутру.', exampleTranslation: 'Шесть утра.' },
      { cyrillic: 'седам', latin: 'sedam', translation: 'семь', exampleCyrillic: 'Седам ујутру је рано.', exampleTranslation: 'Семь утра — рано.' },
      { cyrillic: 'осам', latin: 'osam', translation: 'восемь', exampleCyrillic: 'Осам сати ујутру идем на посао.', exampleTranslation: 'В восемь утра иду на работу.' },
      { cyrillic: 'девет', latin: 'devet', translation: 'девять', exampleCyrillic: 'У девет идем у кинo.', exampleTranslation: 'В девять иду в кино.' },
      { cyrillic: 'десет', latin: 'deset', translation: 'десять', exampleCyrillic: 'Десет минута чекања.', exampleTranslation: 'Десять минут ожидания.' },
      { cyrillic: 'будити се', latin: 'buditi se', translation: 'просыпаться', exampleCyrillic: 'Будим се у седам.', exampleTranslation: 'Я просыпаюсь в семь.' },
      { cyrillic: 'рано', latin: 'rano', translation: 'рано', exampleCyrillic: 'Устајем рано.', exampleTranslation: 'Я просыпаюсь рано.' },
      { cyrillic: 'касно', latin: 'kasno', translation: 'поздно', exampleCyrillic: 'Она је дошла касно.', exampleTranslation: 'Она пришла поздно.' },
      { cyrillic: 'брзо', latin: 'brzo', translation: 'быстро', exampleCyrillic: 'Он говори брзо.', exampleTranslation: 'Он говорит быстро.' },
      { cyrillic: 'споро', latin: 'sporo', translation: 'медленно', exampleCyrillic: 'Воз иде споро.', exampleTranslation: 'Поезд идёт медленно.' },
      { cyrillic: 'ноћас', latin: 'noćas', translation: 'сегодня ночью', exampleCyrillic: 'Ноћас је хладно.', exampleTranslation: 'Сегодня ночью холодно.' },
      { cyrillic: 'време', latin: 'vreme', translation: 'время; погода', exampleCyrillic: 'Време је лепo.', exampleTranslation: 'Погода хорошая.' },
      { cyrillic: 'сада', latin: 'sada', translation: 'сейчас', exampleCyrillic: 'Сад сам слободан.', exampleTranslation: 'Сейчас я свободен.' },
      { cyrillic: 'јануар', latin: 'januar', translation: 'январь', exampleCyrillic: 'Јануар је хладан.', exampleTranslation: 'Январь холодный.' },
      { cyrillic: 'фебруар', latin: 'februar', translation: 'февраль', exampleCyrillic: 'У фебруару је хладно.', exampleTranslation: 'В феврале холодно.' },
      { cyrillic: 'март', latin: 'mart', translation: 'март', exampleCyrillic: 'Март је први проleћни месец.', exampleTranslation: 'Март — первый месяц весны.' },
      { cyrillic: 'април', latin: 'april', translation: 'апрель', exampleCyrillic: 'Април је леп месец.', exampleTranslation: 'Апрель — красивый месяц.' },
      { cyrillic: 'мај', latin: 'maj', translation: 'май', exampleCyrillic: 'У мају је топло.', exampleTranslation: 'В мае тепло.' },
      { cyrillic: 'јун', latin: 'jun', translation: 'июнь', exampleCyrillic: 'У јуну је вруће.', exampleTranslation: 'В июне жарко.' },
      { cyrillic: 'јул', latin: 'jul', translation: 'июль', exampleCyrillic: 'Јул је најтоплији месец.', exampleTranslation: 'Июль — самый жаркий месяц.' },
      { cyrillic: 'август', latin: 'avgust', translation: 'август', exampleCyrillic: 'Август је месец одмора.', exampleTranslation: 'Август — месяц отдыха.' },
      { cyrillic: 'септембар', latin: 'septembar', translation: 'сентябрь', exampleCyrillic: 'У септембру почиње школа.', exampleTranslation: 'В сентябре начинается школа.' },
      { cyrillic: 'октобар', latin: 'oktobar', translation: 'октябрь', exampleCyrillic: 'У октобру је хладно.', exampleTranslation: 'В октябре холодно.' },
      { cyrillic: 'новембар', latin: 'novembar', translation: 'ноябрь', exampleCyrillic: 'Новембар је хладан.', exampleTranslation: 'Ноябрь холодный.' },
      { cyrillic: 'децембар', latin: 'decembar', translation: 'декабрь', exampleCyrillic: 'У децембру је мој рођендан.', exampleTranslation: 'В декабре мой день рождения.' },
      { cyrillic: 'рођендан', latin: 'rođendan', translation: 'день рождения', exampleCyrillic: 'Мој рођендан је у мају.', exampleTranslation: 'Мой день рождения в мае.' },
      { cyrillic: 'зима', latin: 'zima', translation: 'зима', exampleCyrillic: 'Зима је хладна.', exampleTranslation: 'Зима холодная.' },
      { cyrillic: 'лето', latin: 'leto', translation: 'лето', exampleCyrillic: 'Лето је топло.', exampleTranslation: 'Лето тёплое.' },
      { cyrillic: 'проleће', latin: 'proleće', translation: 'весна', exampleCyrillic: 'Проleће је лепo.', exampleTranslation: 'Весна прекрасна.' },
      { cyrillic: 'јесен', latin: 'jesen', translation: 'осень', exampleCyrillic: 'Јесен је хладна.', exampleTranslation: 'Осень холодная.' },
    ],
  },
];
